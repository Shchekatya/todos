...
import { ToDoItem } from "../../components/pages/add-to-do/add-to-do";
...
export type TodoActions = AddTodoAction | CompleteTodoAction | DeleteAction;
...
export const toDoReducer = (state = initialState, action: TodoActions) => {
  switch (action.type) {
    ...
    case DELETE_COMPLETED:
      return {
        ...state,
        todos: state.todos.filter((e) => e.isCompleted === false),
      };
